"""Account Intelligence Agent — Entry Point with AgentCore Memory"""
...
def invoke(payload: dict) -> dict:
    ...
    if not prompt:
        return {"response": "Hello! I'm the Account Intelligence Agent.", "session_id": session_id}
...
if __name__ == "__main__":
    if os.environ.get("LOCAL_MODE", "false").lower() == "true":
        print("Account Intelligence Agent — Local Testing Mode\nType 'quit' to exit.\n")
        while True:
