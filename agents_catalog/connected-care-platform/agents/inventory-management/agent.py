"""Inventory Management Agent — Entry Point with AgentCore Memory"""
...
def invoke(payload: dict) -> dict:
    ...
    if not prompt:
        return {"response": "Hello! I'm the Inventory Management Agent.", "session_id": session_id}
...
if __name__ == "__main__":
    if os.environ.get("LOCAL_MODE", "false").lower() == "true":
        print("Inventory Management Agent — Local Testing Mode\nType 'quit' to exit.\n")
        while True:
